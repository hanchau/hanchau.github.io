...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.20a6fbe84be422d1ad59ead31d5ace0bdcc403fbefed6202a290f13ad7993f16.js',function(){input.required=false;search();});}
