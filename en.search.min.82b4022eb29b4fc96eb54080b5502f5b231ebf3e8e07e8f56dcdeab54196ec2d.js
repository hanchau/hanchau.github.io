...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7bce7006dfe532da15a15cce2ade957b5c4a31188556441634aa06c1e64ec2c1.js',function(){input.required=false;search();});}
